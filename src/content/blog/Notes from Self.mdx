...
<Figure layout="split" caption="Writing is a memory saving device because it records information outside of our brains and we can put this in our brains or activate it when we set eyes to it. It is essentially informational cryogenics.">
