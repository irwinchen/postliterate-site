...
- Phase 6 — Activity summaries.
  ...
  - Slice 2 — Cowork sessions (read `~/.claude/projects/<hash>/*` directly), claude.ai chat exports (`~/Documents/postliterate-chat-exports/*.json`), vault session digests (Phase 7 input). Pending.
